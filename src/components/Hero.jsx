...
import { FaArrowRight, FaMapMarkedAlt, FaAward, FaPlane } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="z-10">
          ...
          <p className="text-gray-600 mt-6 text-lg max-w-lg leading-relaxed">
            Premium spiritual tours, family trips, corporate retreats, and
            unforgettable travel experiences crafted with comfort and devotion.
          </p>
        ...
        <div className="relative h-[600px] w-full hidden lg:block">
          ...
          <div className="absolute bottom-14 left-6 bg-white p-2.5 rounded-[24px] shadow-2xl w-[220px] z-30">
            ...
            <div className="p-2 mt-1">
              ...
              <p className="text-gray-500 text-[12px] mt-0.5">Divine moments</p>
            </div>
          </div>
        </div>
      </div>
